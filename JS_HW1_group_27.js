...
// 1. Создать переменную “item_1”, Присвоить переменной item_1 цифру 5
let item_1 = 5;
...
console.log("sum item_4+item_3 =", item_3+item_4);
...
if(age_1 < age_2){console.log('You dont have access cause your age is ' + age_1 +  "It's less then " + age_2);};
...
if(age_1 > age_3){console.log('Keep calm and watch Culture channel')}
